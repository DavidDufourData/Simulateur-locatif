...
Loyer estimé : 1 050 € par mois.`;
  ...
  const analyze = async () => {
    ...
    setResult(parseAnnouncement(input));
    setStatus("done");
  };
    ...
    return (
      <div className="page-section announcement-page">
        <div className="announcement-result-header">
          <div>
            <span className="eyebrow"><Sparkles size={13} /> ANALYSE PREMIUM</span>
            <h1>{result.city} · T{result.rooms} · {result.surface} m²</h1>
            <p>Analyse indicative générée à partir des informations présentes dans l’annonce.</p>
          </div>
