...
const PREMIUM_STORAGE_KEY = "renta-v6-premium";
  ...
  return (
    <div className="checkout-overlay" role="dialog" aria-modal="true">
      <div className="checkout-modal">
        ...
        {step === "form" && (
          <>
            <div className="checkout-brand"><span><Building2 /></span><b>Renta Locative</b></div>
      ...
      <main className="main">
        <header className="topbar">
          ...
          <div className="top-actions">
            ...
            {isPremium && <button className="premium-status" title={premiumEmail || "Premium actif"}><Crown size={15} /> Premium actif</button>}
        ...
        {page === "goals" && <Goals projects={projects} isPremium={isPremium} onPremiumClick={() => setCheckoutOpen(true)} />}
      </main>
